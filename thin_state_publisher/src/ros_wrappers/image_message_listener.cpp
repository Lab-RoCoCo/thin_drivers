...
namespace fps_mapper {
  ...
  void ImageMessageListener::subscribe(const std::string& image_topic) {
    ...
    _image_subscriber = _image_transport->subscribe(_image_topic, 1, &ImageMessageListener::imageCallback, this);
    _camera_info_subscriber = _node_handle->subscribe<sensor_msgs::CameraInfo>(_camera_info_topic, 1, &ImageMessageListener::cameraInfoCallback, this);
