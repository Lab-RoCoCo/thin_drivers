...
#define carmen_strncasecmp strncasecmp
#define carmen_warn printf
...
int 
carmen_base_direct_initialize_robot(const char *model, const char *dev) 
{
  int i;
  int pioneer_model;
  int result;
